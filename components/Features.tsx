                ...
                <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-3 gap-12 font-sans font-light tracking-wide">
                    <div className="">
                        <Card className="bg-[#e8e5e2] border-none shadow-none">
                            <CardContent className="py-20 px-[3.5rem] space-y-10">
                                <div className="flex items-start mb-4 bg-white rounded-2xl border shadow-md relative">
                                    ...
                                    <div>
                                        <p className="text-lg p-5 text-gray-800 ">Hey <Badge className="text-base font-light py-0 px-2 bg-indigo-50 text-blue-500 rounded-full">@James</Badge> Can you please review this change to our parent and subsidiary structure in the US?</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start mb-4 ml-16 bg-white rounded-2xl border shadow-md relative">
                                    ...
                                    <div>
                                        <p className="text-lg p-5 text-gray-800 ">Hi <Badge className="text-base font-light py-0 px-2 bg-indigo-50 text-blue-500 rounded-full">@Andi</Badge> Sure thing. I can see you’ve already uploaded files for me - thanks!</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <div className="">
                        <Card className="bg-[#F9F7F4] border-none shadow-none h-full p-0">
                    ...
                    <div className="">
                        <Card className="bg-[#e8e5e2] border-none shadow-none flex-1 ">
