...
export default function Component() {
    ...
    return (
        <div className="scroll-mt-32 bg-[#F9F7F4] py-12  px-[18rem]" id="features" ref={ref}>
            ...
            {/* Grid */}
            <div className="grid grid-cols-1 2xl:grid-cols-2 md:grid-rows-3 gap-x-12 gap-y-6 font-sans font-light tracking-wide">
                <div className="flex flex-col items-end justify-end">
                    <Card className="bg-[#b2a698]/[0.12] border-none shadow-none h-[25rem] mb-10">
                ...
                <div className="flex flex-col gap-2">
                    <Card className="bg-[#b2a698]/[0.12] border-none shadow-none h-[25rem] ">
